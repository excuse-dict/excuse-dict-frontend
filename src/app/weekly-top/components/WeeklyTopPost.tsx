...
export default function WeeklyTopPost({ postProp, postsHook }: {
    ...
    return (
        <article
            className={`global_button !cursor-default w-full !bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-8 border border-gray-100 ${
            ...
            >
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        {/*hot 스코어*/}
                        <div className="pl-2 text-red-400">{`🔥${post.hotScore}`}</div>
                    </div>
                    {/*태그*/}
